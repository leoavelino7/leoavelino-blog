...
export const BannerMain: FC<ComponentI18n> = ({ translate, loading }) => (
        ...
        <div className="col-span-1 flex flex-col justify-center items-start gap-3">
          ...
          <ButtonLink
            to={
              loading
                ? ""
                : AppLinks.homeCategories(translate("section_category_id"))
            }
          >
            {loading ? (
              <Skeleton width="120px" />
            ) : (
              translate("main_banner_button")
            )}
