      ...
      <main className="bg-paper-light">
        <header className="flex flex-col justify-center items-center px-4 pt-24 pb-12">
          <p className="flex flex-row gap-x-2 items-center text-primary font-medium font-poppins">
            ...
            <span
              aria-hidden="true"
              className="rounded-full w-2 h-2 bg-primary"
            />
            {i18n.resolvedLanguage &&
          ...
          <h1 className="font-poppins text-neutral-dark font-bold text-4xl md:text-5xl mt-3 text-center">
            {data.post.title}
          </h1>
          <h2 className="font-poppins text-neutral font-medium text-lg md:text-xl text-center mt-4 mb-6 max-w-7xl">
            {data.post.description}
          </h2>
          <h3>
            <Chip
              className={`${
                CategoriesLib.categoriesColor[
                  data.post.category.slug as CategoriesLib.Categories
                ]
        ...
        <section>
          ...
          <section className="px-4 mx-auto w-full max-w-4xl">
